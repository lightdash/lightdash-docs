...
Once you've finished creating your chart, you can share it using the URL, save the chart, download it as an image, copy it to your clipboard, or save it to a dashboard.
