...
Users provisioned via SCIM are marked as verified and their emails can be trusted. This means that users provisioned via SCIM can log in without needing to verify their email address.
