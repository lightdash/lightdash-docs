...
| [`download`](#lightdash-download)                     | Downloads all charts and dashboards from your Lightdash project as code         |
| [`upload`](#lightdash-upload)                         | Uploads all updates to charts and dashboards as code to your Lightdash project  |
...
Downloads all charts and dashboards from your Lightdash project as code. A `lightdash` directory is created in your dbt project and all of the charts and dashboards are written there as .yml files. 
...
Uploads all charts and dashboards from the `lightdash/` directory in your dbt project to your Lightdash project. 

`lightdash upload` will update or create all of the charts or dashboards in the Lightdash application. If there have been changes made to a chart or dashboard in the application that is being uploaded from code, `lightdash upload` will overwrite the changes.
