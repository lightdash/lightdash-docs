...
From the [Lightdash CLI](/references/lightdash-cli), you can use the command `lightdash upload` to upload any updated charts and dashboards saved as .yml in your `lightdash/` directory in your dbt project to the Lightdash application. To upload new charts that you've created as code to your Lightdash project, you need to run `lightdash upload --force`
