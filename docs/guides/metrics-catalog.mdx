...
Spotlight is a suite of features designed to put Metrics front and center. They simplify data exploration, making it easy for business users to focus on metrics without dealing with complex tables or time dimensions.
